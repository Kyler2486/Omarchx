...
if omarchx-hw-dell-xps-haptic-touchpad; then
  ...
  sudo rm -f /etc/omarchx-dell-haptic-touchpad.env
  sudo systemctl daemon-reload
  sudo udevadm control --reload-rules

  source "$OMARCHX_PATH/install/packaging/dell-xps-touchpad-haptics.sh"
fi
