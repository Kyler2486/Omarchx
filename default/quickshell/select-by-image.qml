...
ShellRoot {
  ...
  property string imageDirs: Quickshell.env("OMARCHX_IMAGE_SELECTOR_DIRS") || Quickshell.env("OMARCHX_IMAGE_SELECTOR_DIR") || Quickshell.env("OMARCHX_STOCK_BACKGROUNDS_DIR") || (Quickshell.env("HOME") + "/.config/omarchx/current/theme/backgrounds")
  property string imageRows: ""
  property string selectionFile: Quickshell.env("OMARCHX_IMAGE_SELECTOR_SELECTION_FILE") || Quickshell.env("OMARCHX_BACKGROUND_SELECTION_FILE")
  property string selectedImage: Quickshell.env("OMARCHX_IMAGE_SELECTOR_SELECTED")
  property string colorsFile: Quickshell.env("OMARCHX_IMAGE_SELECTOR_COLORS_FILE") || (Quickshell.env("HOME") + "/.config/omarchx/current/theme/quickshell.json")
  ...
  property string socketPath: (Quickshell.env("XDG_RUNTIME_DIR") || ("/run/user/" + Quickshell.env("UID"))) + "/omarchx-image-selector.sock"
  ...
  function openSelector(nextImageDirs, nextImageRows, nextSelectedImage, nextSelectionFile, nextDoneFile, nextColorsFile, nextColorsRaw, nextShowLabels, nextFilterable) {
    ...
    filterText = ""
    colorsFile = nextColorsFile || (Quickshell.env("HOME") + "/.config/omarchx/current/theme/quickshell.json")
    if (nextColorsRaw)
  ...
  Component.onCompleted: {
    if (selectionFile)
      openSelector(imageDirs, "", selectedImage, selectionFile, Quickshell.env("OMARCHX_IMAGE_SELECTOR_DONE_FILE"), colorsFile, "", false, false)
  }
  ...
  PanelWindow {
    ...
    color: "transparent"
    WlrLayershell.namespace: "omarchx-image-selector"
