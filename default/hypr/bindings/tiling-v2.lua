...
o.bind("CTRL + ALT + DELETE", "Close all windows", "omarchx-hyprland-window-close-all")
...
o.bind("SUPER + O", "Pop window out (float & pin)", "omarchx-hyprland-window-pop")
o.bind("SUPER + L", "Toggle workspace layout", "omarchx-hyprland-workspace-layout-toggle")
...
o.bind("SUPER + code:61", "Cycle monitor scaling", "omarchx-hyprland-monitor-scaling-cycle")
o.bind("SUPER + ALT + code:61", "Cycle monitor scaling backwards", "omarchx-hyprland-monitor-scaling-cycle --reverse")
