...
o.window("(org.omarchx.bluetui|org.omarchx.impala|org.omarchx.wiremix|org.omarchx.btop|org.omarchx.terminal|org.omarchx.bash|org.codeberg.dnkl.foot|org.gnome.NautilusPreviewer|org.gnome.Evince|com.gabm.satty|Omarchx|About|TUI.float|imv|mpv)", { tag = "+floating-window" })
...
o.window("org.omarchx.screensaver", { fullscreen = true, float = true, animation = "slide" })
...
hl.layer_rule({ match = { namespace = "omarchx-image-selector" }, no_anim = true })
