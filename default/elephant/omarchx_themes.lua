--
-- Dynamic Omarchx Theme Menu for Elephant/Walker
--
Name = "omarchxthemes"
NamePretty = "Omarchx Themes"
...
function GetEntries()
  local entries = {}
  local user_theme_dir = os.getenv("HOME") .. "/.config/omarchx/themes"
  local omarchx_path = os.getenv("OMARCHX_PATH") or ""
  local default_theme_dir = omarchx_path .. "/themes"
      ...
      if theme_name and not seen_themes[theme_name] then
        ...
        if preview_path and preview_path ~= "" then
          ...
          table.insert(entries, {
            ...
            PreviewType = "file",
            Actions = {
              activate = "omarchx-theme-set " .. theme_name,
            },
          })
        end
      end
