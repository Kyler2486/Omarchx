...
class TranscodeAction(GObject.GObject, Nautilus.MenuProvider):
    def _launch_transcode(self, paths):
        wrapper = shutil.which("omarchx-launch-floating-terminal-with-presentation")
        binary = shutil.which("omarchx-transcode")
    ...
    def _make_item(self, paths):
        ...
        item = Nautilus.MenuItem(
            name="OmarchxTranscodeNautilus::transcode",
            label=label,
    ...
    def _tools_available(self):
        return bool(
            shutil.which("omarchx-launch-floating-terminal-with-presentation")
            and shutil.which("omarchx-transcode")
        )
