if command -v limine &>/dev/null; then
  sudo tee /etc/mkinitcpio.conf.d/omarchx_hooks.conf <<EOF >/dev/null
...
EOF
  ...
  sudo cp $OMARCHX_PATH/default/limine/default.conf /etc/default/limine
  ...
  sudo cp $OMARCHX_PATH/default/limine/limine.conf /boot/limine.conf
  ...
  sudo cp $OMARCHX_PATH/default/snapper/root /etc/snapper/configs/root
