...
o.bind("SUPER + ALT + RETURN", "Tmux", { omarchx = "terminal-tmux" })
...
o.bind("SUPER + SHIFT + M", "Music", { omarchx = "or-focus spotify" })
...
-- o.bind("SUPER + SPACE", "Omarchx menu", "omarchx-menu")

-- Logitech MX Keys examples:
-- o.bind("SUPER + SHIFT + S", nil, "omarchx-capture-screenshot")
-- o.bind("SUPER + H", nil, "voxtype record toggle")
-- o.bind("SUPER + PERIOD", nil, { omarchx = "walker -m symbols" })
